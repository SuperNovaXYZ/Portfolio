  ...
  return (
    <div className ="z-10 mt-20 text-center md:mt-40 md:text-left rounded-3xl bg-clip-text">
        ...
        <div className="flex-col hidden md:flex c-space">
            ...
            > A Software Developer Dedicated To Learning</motion.p>
            <motion.div
            variants={variants}
            initial={"hidden"}
            animate={"visible"}
            transition={{delay:1.5}}> <FlipWords words={words} className="font-black text-white text-8xl"/> </motion.div>
        ...
        <motion.p className="text-4xl font-medium" 
            ...
            animate={"visible"}
            transition={{delay:1}}
            > Hi, Im Nova </motion.p><div>
            <p className="text-5xl font-black text-neutral-300" 
            variants={variants}
            initial={"hidden"}
            animate={"visible"}
            transition={{delay:1.2}}>Building</p>
            <motion.div 
            variants={variants}
            initial={"hidden"}
            animate={"visible"}
