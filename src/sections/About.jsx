  ...
  const grid2Container=useRef();
    ...
    <section className="c-space section-spacing"> 
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          <div className="z-10">
            <p className="headtext">Hi, Im Nova Alim</p>
            <p className="subtext">Im a Software Developer that is passionate about delivering efficient and  </p>
          </div>
        ...
        <div className="grid-default-color grid-2"> 
          <div ref={grid2Container} className="flex items-center justify-center w-full h-full" > 
            ...
            <Card style={{rotate:"-45deg",top:"55%", left:"0%"}} text="Patterns" containerRef={grid2Container}/>
            <Card style={{rotate:"20deg",top:"10%", left:"38%"}} text="Efficient" containerRef={grid2Container}/>
        ...
        <div className="grid-black-color grid-3"> 
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext"> Im Based In the US, and open to remote work!</p>
          </div>
